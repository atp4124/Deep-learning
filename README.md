...
When j=n, we have:
$$
\frac{\partial L}{\partial \textbf{X}} = \frac{\partial L}{\partial Y\_{ij}}\frac{e^{X\_{in}}}{\sum\_{k}e^{X\_{ik}}}\Bigg(1 - \frac{e^{X\_{ij}}}{\sum_{k}e^{X\_{ik}}}\Bigg)
$$
When $j\neq n$, we have:
$$
...
$\frac{\partial L}{\gamma\_{i}} = \sum_{sj}\frac{\partial L}{\partial Y\_{sj}}\hat{X}\_{sj}\delta\_{ji} = \sum\_{s}\frac{\partial L}{\partial Y'_{si}}\hat{X}\_{si}$
...
$\frac{\partial L}{\partial X\_{ri}} = \frac{1}{M\sqrt{\sigma\_{s}^{2}+\epsilon}}\Big[M\frac{\partial L}{\partial \hat{X}\_{ri}}\gamma\_{i}-\sum_{j}\frac{\partial L}{\partial \hat{X}\_{rj}}\gamma\_{j} - \sum\_{j}\frac{\partial L}{\partial \hat{X}\_{rj}}\hat{X}\_{rj}\gamma\_{j}\Big(\hat{X}\_{ri} - \frac{1}{M}\sum\_{p=1}^{M}\hat{X}\_{rp}\Big)\Big]$
